...
# # ================= BOT TOKEN =================
#
# BOT_TOKEN = "8652158338:AAH-oRZzSj795lKNNK2LNUmNVdVgMWa0x8c"
#
#
# # ================= CATEGORY URLS =================
#
...
# # ================= SHOW MOVIES =================
#
# async def show_movies(update, context, movies):
#
#     if not movies:
#
...
#         return
#
#     grouped_movies = group_movies(movies)
#
#     context.user_data["grouped_movies"] = grouped_movies
#
#     keyboard = []
#
#     for i, title in enumerate(grouped_movies.keys()):
#
#         keyboard.append([
#             InlineKeyboardButton(
#                 title,
#                 callback_data=f"group_{i}"
#             )
#         ])
#
...
#
#     grouped_movies = list(
#         context.user_data["grouped_movies"].values()
#     )
#
#     variants = grouped_movies[index]
#
...
#
#     data = get_download_links(movie["url"])
#
...
#
#     url = CATEGORY_URLS[update.message.text]
#
#     movies = get_category_movies(url)
#
#     await show_movies(update, context, movies)
#
#
...
# # ================= LATEST VIDEOS =================
#
# async def latest_videos(update, context):
#
#     msg = await update.message.reply_text(
...
#     elif text == "🔥 Trending":
#
#         await trending_handler(update, context)
#
...
async def suggest_movies(update, context):
...
async def suggestion_selected(update, context):
    ...
    movie = context.user_data["suggestions"][index]

    results = search_movie(movie["title"])

    await show_movies(query, context, results)
...
async def menu_handler(update, context):
    ...
    if text == "🎬 Search Movie":
        ...
        await suggest_movies(update, context)
